...
# Invoke this with python3 -m pytest -s -k "test_contract_aave_borrow_eth_with_approval"
def test_contract_aave_borrow_eth_with_approval(setup_fork):
    token = "ETH"
    amount = 0.1
    ...
    assert multistep_result.description == "Approve borrow of 0.1 ETH on Aave"
